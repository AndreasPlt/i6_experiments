...
RASR_BINARY_PATH = tk.Path("/work/asr3/vieting/hiwis/pletschko/dev/rasr_onnx_115_24_01_24/arch/linux-x86_64-standard")
RASR_BINARY_PATH.hash_overwrite = "LIBRISPEECH_DEFAULT_RASR_BINARY_PATH"

def run_librispeech_100_common_baseline(
    alias_prefix: str = "alignments/librispeech/ls100/gmm/common_baseline",
    ...
    steps.add_step(
        "forced_align_mono",
        {
            "name": "ls960_align_mono",
            "target_corpus_keys": ["train-other-960"],
            "flow": "mfcc+deriv+norm",
            "feature_scorer": ("train-clean-100", "train_mono"),
            "corpus_keys": ["train-other-960"],
        }
    )
