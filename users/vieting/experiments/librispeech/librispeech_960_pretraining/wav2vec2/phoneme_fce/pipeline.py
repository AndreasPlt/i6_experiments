...
from i6_experiments.users.vieting.experiments.librispeech.librispeech_960_pretraining.wav2vec2. \
    config_01_fairseq_main import get_fairseq_args, get_fairseq_root
...
def create_fresh_model_file():
    # run pre-training
    exp_name = "dummy_pretraining"
    num_gpus = 1
    ...
    fairseq_root = get_fairseq_root(fairseq_exe=fairseq_exe)
    ...
    return job.out_models["_last"].model
