...
from .w2v_hybrid_wrapper_cfg import ModelConfig
...
class Model(torch.nn.Module):
    ...
    def forward(
        ...
        **kwargs
        ...
        model_out = res["encoder_out"] # [T, B, C]/[B, T, C]
        padding_mask = res["padding_mask"] # [T, B]
        logits = self.w2v_model.get_logits(res)  # []
        logprobs = self.w2v_model.get_normalized_probs(res, log_probs=True) # [T, B, C]
